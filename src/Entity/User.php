 ...
 * @UniqueEntity(
 *  fields={"email"},
 *  message="Un autre utilisateur s'est déjà inscrit avec cet email, merci de le modifier")
 */
class User implements UserInterface
{
     ...
     * @Assert\Length(min=100, minMessage="Votre introduction doit faire au moins {{limit}} caractères")
     */
    private $description;
