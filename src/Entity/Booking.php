...
class Booking
{
     ...
     * @Assert\GreaterThan("today", message="La date d'arrivée doit être ultérieur au jour de réservation !")
     */
    private $startDate;
    ...
    /**
     * Callback appelé à chaque fois que l'on créé une résercvation
     * 
     * @ORM\PrePersist
     *
     * @return void
    ...
    {
        // Connaitre les dates impossibles
    ...
    /**
     * Permet de récupérer un tableau des journées de la résa
     *
     * @return array un tableau d'objets DateTime des jours de résa
     */
